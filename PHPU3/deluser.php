        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="deluser.php">Baja usuario</a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
    </nav>
...
<section class="formularioRegistro">
    <h2>Eliminar Coche de la base de datos</h2>
            <form role="form" action="rmuser.php" method="POST">
                    <div class="form-group col-md-6">
                    <input type="text" class="form-control" name="deluser" placeholder ="telefono del usuario" required>
                    </div>
